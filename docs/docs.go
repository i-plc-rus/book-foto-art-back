...
const docTemplate = `{
    ...
    "paths": {
        ...
        "/profile/subscription/extend": {
            "post": {
                ...
                "parameters": [
                    {
                        "type": "string",
                        "description": "План подписки (месяц, год)",
                        "name": "plan",
                        "in": "formData",
                        "required": true
                    }
        ...
        "/profile/subscription/result/{payment_id}": {
            "get": {
    ...
    "definitions": {
        ...
        "model.CreatePaymentResponse": {
            ...
            "properties": {
                "confirmation_url": {
                    "type": "string",
                    "example": "https://yoomoney.ru/checkout/payments/v2/contract?orderId=304b552c-000f-5000-b000-1355c1d6c469"
                }
            }
        },
        "model.ErrorMessage": {
